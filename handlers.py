...
def forward_to_chat(update, context):
    """{ 
        'message_id': 5, 
        'date': 1605106546, 
        'chat': {'آی دی عددی': 49820636, 'نوع': 'private', 'یوزرنیم': 'danokhlopkov', 'اسم': 'Daniil', 'فامیل': 'Okhlopkov'}, 
        'text': 'TEST QOO', 'entities': [], 'caption_entities': [], 'photo': [], 'new_chat_members': [], 'new_chat_photo': [], 'delete_chat_photo': False, 'group_chat_created': False, 'supergroup_chat_created': False, 'channel_chat_created': False, 
        'from': {'آی دی عددی': 49820636, 'اسم': 'Daniil', 'رباته؟': نه, 'فامیل': 'Okhlopkov', 'یوزرنیم': 'danokhlopkov', 'زبان': 'en'}
    }"""
...
def forward_to_user(update, context):
    """{
        ...
        'reply_to_message': {
            ...
            'chat': {'id': -484179205, 'type': 'group', 'title': '☎️ SUPPORT CHAT', 'all_members_are_administrators': True}, 
            'forward_from': {'آی دی عددی': 49820636, 'نام': 'Daniil', 'رباته؟': نه, 'فامیل': 'Okhlopkov', 'danokhlopkov': 'okhlopkov', 'زبان': 'en'}, 
            ...
            'from': {'آی دی عددی': 1440913096, 'نام': 'SUPPORT', 'رباته؟': ر, 'یوزرنیم': 'lolkek'}
        }, 
        ...
        'from': {'آی دی عددی': 49820636, 'نام': 'Daniil', 'رباته؟': ن, 'فامیل': 'Okhlopkov', 'یوزرنیم': 'danokhlopkov', 'زبان': 'en'}
    }"""
    user_id = None
